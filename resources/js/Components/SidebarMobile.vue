<template>
  ...
  >
    <div class="py-4 text-gray-500">
      <h1 class="mt-2 text-blue-600 font-medium text-2xl text-center">
        financeapp.
      </h1>
      <ul class="mt-6">
        <li class="relative px-3" v-for="(sidebarLink, i) in links" :key="i">
          <Link
            ...
            class="rounded-lg mt-4 px-5 py-3 inline-flex items-center w-full text-base font-semibold transition-all duration-100 hover:bg-blue-600 hover:text-white"
            :class="
