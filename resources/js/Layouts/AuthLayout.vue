        ...
        <header class="z-10 py-4 bg-white shadow">
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                ...
                <button ref="refBtnProfile"
                    ...
                    <!-- user has avatar -->
                    <img v-if="$page.props.auth.user.data.avatar" lazy="true" 
                    class="w-6 h-6 rounded-full hover:cursor-pointer hover:border border-sky-600 transition-all duration-75"
                    :src="$page.props.auth.user.data.avatar"/>

                    <!-- user no avatar -->
                    <UserCircleIcon v-else
                    class="w-5 h-5 text-gray-500 hover:text-gray-800 hover:cursor-pointer hover:border border-sky-600 transition-all duration-100" />
